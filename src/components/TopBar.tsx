  ...
  return (
    <>
      <header className="h-14 border-b bg-card flex items-center gap-3 px-4 sticky top-0 z-30">
        <button className="md:hidden p-2 -ml-2 rounded-md hover:bg-muted" onClick={() => setMobileMenuOpen(true)}>
        ...
        <button className="relative p-2 rounded-md hover:bg-muted">
          ...
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-priority-urgent rounded-full" />
        </button>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-64 bg-sidebar animate-slide-in">
